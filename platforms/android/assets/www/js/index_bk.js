...
var calcLocation = {
    ...
    */
    main: function(){
      ...
      myVar = setInterval(calcLocation.deviceScan, 1000);
    },
    /*
    code by C.H Chiang
    ...
    */
    getBeaconData: function(name){
        var data = {beaconName: name};
        if(beaconData["config"] === undefined){
          calcLocation.addBeaconData("config", 0, 0);          
        }
        else if(beaconData[name] === undefined){
            $.ajax({
                ...
                success: function(result){
                    ...
                    //     console.log(result['uuid'][i] + " " + x + " " + y);
                    //     calcLocation.addBeaconData(result['uuid'][i], x, y);
                    // }
                    console.log("asdasdsa "+result['uuid']+" "+result['locationX']+" "+result['locationY']);
                },
                error: function(){
          ...
          function(result){
              if(result.status === "scanStarted"){
                ...
                if(beaconData[name] != undefined){
                  ...
                  calcLocation.getBeaconData(name);
                }
              }
          },
